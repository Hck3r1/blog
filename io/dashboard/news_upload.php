...
<body>
    ...
    if(isset($_REQUEST['submit'])){
        ...
        $sql="INSERT INTO news (uin, date, category, headline, content, cover, credit, embed, a, postview) VALUES ('$uin','$date','$category','$headline','$content','$cover','$credit','$embed','$headline4','0')";
...
echo "<script>alert('News has been uploaded successfully')</script>";
	...
	echo "<script>alert('Error in Uploading Passport')</script>";	
				...
				?>
                                    ...
                                    <div class="form-group"><label>Link</label> <textarea  placeholder="Enter Link" name="a" class="form-control" ></textarea></div>
